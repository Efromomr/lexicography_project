...
def get_post_javascript_data():
    ...
    return render_template('dict_page.html', name=jsdata, author = jsdata, online=jsdata)
...
def user_search():
    ...
    for i, example in enumerate(data):
        example.append(i+1)
    return render_template('dict_page.html', data=data, res = 'Результат запроса:', q=query, qq='Ваш запрос: ')
